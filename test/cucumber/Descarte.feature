Feature: Agendar o descarte de um equipamento
	...
	Eu gostaria de agendar o descarte de equipamentos que estão armazenados no "cemitério"

Scenario: Descarte de um equipamento com sucesso
	Given O sistema possui o equipamento "5547/2012" cadastrado
	And O equipamento "5547/2012" possui o status "Pronto para descarte".
...
Scenario: Menagem de sucesso ao agendar o descarte de um equipamento
	Given Eu estou na Página de Descarte de Equipamentos
